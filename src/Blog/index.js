...
import plane from '../assets/plane_small.svg';
          ...
          <div className="row">
            ...
            <div className="col-xs-12 col-lg-4">
              <Post
                ...
                text="
                  Электронный авиабилет — это, по сути, обычный билет на самолет, но только
            ...
            <div className="col-xs-12 col-lg-4">
              <Post
                ...
                text="
                  Есть масса путеводителей по странам, но ни одного о том, как провести время
